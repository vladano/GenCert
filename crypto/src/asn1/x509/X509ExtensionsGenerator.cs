...
namespace Org.BouncyCastle.Asn1.X509
{
	...
	public class X509ExtensionsGenerator
	{
            ...
            bool isCopy=false)
		{
            ...
            try
			{
                //var a = extValue.GetEncoded();
                encoded = extValue.GetDerEncoded();
                //Asn1Object b = extValue.ToAsn1Object();
                //byte [] c= b.GetDerEncoded();
                //byte[] d = b.GetEncoded();
                if (isCopy)
                {
                    encodedTmp = new byte[encoded.Length - 2];
                    Array.Copy(encoded, 2, encodedTmp, 0, encoded.Length - 2);
                    encoded = encodedTmp;
                }
            }
            catch (Exception e)
            ...
            //this.AddExtension(oid, critical, encodedTmp);
        }
